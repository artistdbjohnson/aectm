...
export function CalendarView() {
  ...
  return (
    <article className="page-wrap py-10">
      ...
      <div className="grid gap-stack lg:grid-cols-[1.15fr_0.85fr]">
        ...
        <div className="stack-cards">
          <div className="glass rounded-[28px]">
            ...
            {selectedSpans.length ? (
              <ul className="stack-rows mt-4">
                {selectedSpans.map((s) => (
                  <li key={s.id} className="list-row rounded-2xl border border-line bg-white/30 text-sm">
  ...
  return (
    <li>
      <button
        ...
        className="list-row w-full rounded-2xl border border-line bg-white/25 text-left text-sm hover:bg-white/45"
      >
